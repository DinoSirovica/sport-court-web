                        ...
                        <CardContent className="pt-2 pb-1" sx={{alignItems: "center", height: "100%"}}>
                            <Row xs={1} style={{height: "100%"}} className="align-items-center">
                                <Col sm={4} xs={12} className="p-2 pe-0 text-center">
                                    <Avatar sx={{width: "70px", height: "70px", margin: "0 auto"}}
                                            src={getImageFromBase64(friend.imageData)}></Avatar>
                                </Col>
                                <Col sm={8} xs={12} className="text-center">
                                    <div className="d-flex flex-column justify-content-center h-100">
                                        <div style={{
                                            fontSize: "1.7em",
                                            color: hoveredIndex === index ? theme.palette.secondary.main : theme.palette.primary.darker
                                        }}>
